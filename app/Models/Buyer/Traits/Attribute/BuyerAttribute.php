<?php
namespace App\Models\Buyer\Traits\Attribute;

/**
 * Class CompanyAttribute.
 */
trait BuyerAttribute {
    /**
     * @return string
     */
    public function getActionButtonsAttribute() {
        return '<div class="btn-group action-btn">'.
        $this->statusButton('buyer-edit', 'admin.buyer.edit').
        $this->editButton('buyer_edit', 'admin.buyer.edit').
        $this->view('buyer_show', 'admin.buyer.show').
        $this->deleteButton('buyer_delete', 'admin.buyer.destroy').
        '</div>';
    }
    /**
     * Show Users
