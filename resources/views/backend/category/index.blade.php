...
@section('page-header')
{{ trans('global.category_management') }}
@endsection
@section('content')
        ...
        <div class="card-header">
            <div class="card-tools">
                ...
                <a class="btn btn-primary btn-sm" href="{{ route("admin.category.create") }}">
                    <i class="mr-1 fas fa-plus"></i>{{ trans('global.add') }} {{ trans('global.category.title_singular') }}
                </a>
                @endcan
            </div>
        </div>
                        ...
                        <div class="box-body">
                            <div class="table-responsive-lg data-table-wrapper">
                                <table id="category_table" class=" table table-bordered table-striped table-hover datatable">
                                    ...
                                    <thead>
                                        <tr>
                                            <th><input type="text" class="form-control text-search" name="name" data-column="0" placeholder="{{ trans('global.category_name') }}"></th>
                                            <th>
...
<script>
    $(function() {
        ...
        $(document).on('click','.change_status',function(e){
            ...
            $.ajax({
                url: "{{URL('admin/category/changeStatus')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}', 
