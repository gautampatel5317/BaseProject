...
return [
    ...
    'email_template_management' => 'Gestion des modèles d\'e-mails',
    'email_template' => [
        'active' => 'Active',
        'inactive' => 'Inactive',
    ...
    'cms_management' => 'Gestion des pages',
    'cms' => [
        'title' => 'Pages',
        'title_singular' => 'Page',
        'fields' => [
    ...
    'youWontbeAbletoDelete' => "Vous ne pourrez pas supprimer ceci!",
    'yesDeleteIt' => "Oui, supprimez-le!",
    'deleting' => "Suppression ...",
    'deleted' => "Supprimé!",
    'success' => "success",
    'data_has_been_deleted' => "Les données ont été supprimées.",
